...
@Component({
  selector: 'app-dis-returnstock',
  templateUrl: './dis-returnstock.component.html',
  styleUrls: ['./dis-returnstock.component.css']
})
export class DisReturnstockComponent implements OnInit{
...
uid:any = localStorage.getItem('uid');   // distributor id
  ...
  statusdata: string = "AdSaleReturnPending"
